...
[![Build Status](https://travis-ci.org/davideDagostino/api-generator.svg?branch=master)](https://travis-ci.org/davideDagostino/api-generator)
...
6. If you did everything correct, https://davidedagostino.github.io/api-generator/ will lead to your new docs
...
- Documentation(ReDoc): https://davidedagostino.github.io/api-generator/
- SwaggerUI: https://davidedagostino.github.io/api-generator/swagger-ui/
- Look full spec:
    + JSON https://davidedagostino.github.io/api-generator/swagger.json
    + YAML https://davidedagostino.github.io/api-generator/swagger.yaml
- Preview spec version for branch `[branch]`: https://davidedagostino.github.io/api-generator/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://davidedagostino.github.io/api-generator/ with url from the message: `Server started <url>`
